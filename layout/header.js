...
function Header() {
  ...
  return (
    <>
      <div className="p-2 text-[13px] text-white main-bg">
      ...
      <div className="sticky top-0 z-10">
              ...
              {contacts.map((contact, i) => (
                <div key={i} className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{contact.link}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="bg-white">
          <div className="container flex flex-row items-center justify-between mx-auto ">
            <div className="flex-row hidden md:flex">
              {menu.map((m, i) => (
                <Link to={`/${m.link}`} key={i}>
                  <p
                    className={`px-5 pt-5 pb-3 text-[15px] ${
            ...
            <div>
              <button className="main-bg rounded-bl-3xl rounded-tr-3xl text-white px-10 py-3 text-[13px] mt-2 flex items-center gap-3 font-medium">
                <span>Order Now</span>
        ...
        <svg
          ...
          className="w-full sm:h-8 fill-white"
        >
          <path
