    ...
    <div>
      ...
      <div className="container flex flex-col gap-8 py-16 mx-auto lg:flex-row">
        <div className="w-full lg:w-2/5">
          <p className="italic tint-color">For more Information</p>
          <h3 className="mt-3 mb-6 text-3xl font-black main-color">
            Hey, let's talk!
          </h3>
        ...
        <div className="flex-1">
          <h3 className="mt-3 mb-6 text-3xl font-bold main-color">
            Send Us A Message
          </h3>
          <p className="my-6">
