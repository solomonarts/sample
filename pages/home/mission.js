...
function Mission() {
  return (
    <div className="container flex flex-col-reverse items-center gap-10 pt-16 mx-auto md:flex-row">
      <div className="w-full">
        <Slide triggerOnce direction="up">
          <img src={post} alt="Mission" className="max-h-[28rem] mx-auto" />
        </Slide>
      </div>
      <div className="w-full">
        <Slide triggerOnce direction="right">
          <p className="text-lg italic tint-color">About Stellar Dairies</p>
          <h3 className="my-3 text-3xl font-black main-color">
            WE CREATE THE BEST DAIRY PRODUCT
          </h3>
          <p className="mt-3">
            With a background in manufacturing engineering and facing
            unemployment, Out CEO quickly jumped into training for yoghurt
            production and later birthed Stellar Dairyland. The rest is history
            as they say.
          </p>
          ...
          <div className="mt-6 mb-4">
            ...
            <p>
              To be the leading producer of premium milk products such
              pro-biotic yoghurt, mala, flavored milk in Kenya, and beyond.
            </p>
          </div>
          <div>
