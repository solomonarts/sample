...
import bg from "../assets/stellar-bg.png"
import { Slide } from 'react-awesome-reveal'

function PageHead({ title }) {
    return (
        <div className='bg-center bg-no-repeat bg-cover' style={{ backgroundImage: `url(${bg})` }}>
            <div className='max-w-lg pt-32 pb-16 mx-auto text-center'>
                <Slide triggerOnce direction='up'><h2 className='text-4xl font-bold text-white'>{title}</h2></Slide>
            </div>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 283.5 27.8" preserveAspectRatio="none" className='w-full h-6 rotate-180 fill-white'>
