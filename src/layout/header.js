...
import { contacts, menu, socials } from "../constants/menu";
    ...
    <>
      <div className="p-2 text-sm text-white main-bg">
        <div className="container flex flex-col justify-between gap-3 mx-auto sm:flex-row">
          <p>Working Time: Mon - Thu 7:00 AM - 7:00 PM</p>
      ...
      <div className="sticky top-0 z-10">
        ...
        <div className="bg-white">
          <div className="container flex flex-row items-center justify-between mx-auto ">
            <div className="grid-flow-col hidden md:grid justify-start gap-2">
              {menu.map((m, i) => (
                <Link to={`/${m.link}`} key={i}>
                  <p
                    className={`px-3 pt-5 pb-3 font-medium ${
                      active === m.link && "active"
                    }`}
                  >
                    {m.label}
                  </p>
            ...
            <div>
              <a className="flex gap-2 items-center" href="/order-now">
                <button className="main-bg rounded-bl-3xl rounded-tr-3xl text-white px-5 py-3 text-[13px] mt-2 flex items-center gap-3 font-medium">
                  <span>Order Now</span>
                  <FaLongArrowAltRight />
                </button>
              </a>
        ...
        <svg
          ...
          className="w-full sm:h-12 fill-white"
        >
          <path
