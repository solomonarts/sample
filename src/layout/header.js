    ...
    return (
        <>
            ...
            <div className='sticky top-0 z-10'>
                ...
                <div className='bg-white'>
                    <div className='container flex flex-row items-center justify-between mx-auto '>
                        <div className='flex-row hidden md:flex'>
                            {menu.map((m, i) => <Link to={`/${m.link}`} key={i}><p className={`px-5 pt-5 pb-3 font-medium ${active === m.link && 'active'}`}>{m.label}</p></Link>)}
                        </div>
                ...
                <svg viewBox="0 0 283.5 27.8" preserveAspectRatio="none" className='w-full sm:h-12 fill-white'>
