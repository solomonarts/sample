...
function Team() {
    ...
    return (
        <div className='container py-16 mx-auto'>
            <h3 className='mt-3 mb-8 text-4xl font-black uppercase main-color'>The team</h3>

            <div className='grid grid-cols-2 gap-6 lg:grid-cols-4'>
                {members.map((member, i) => <div key={i} className='p-5 overflow-hidden border rounded-lg'>
                    <div className='flex justify-center'>
                        <img src={member.photo} alt={member.name} className='aspect-[1/1] w-40 rounded-full' />
                    </div>
